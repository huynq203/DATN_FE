      ...
      <div className='container'>
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-centertext-sm'>
            <Link to={paths.Screens.AUTH_LOGIN} className='mr-2 hover:text-gray-300 font-sans'>
              Đăng nhập
            </Link>
            <div className='border-r-2 border-r-white h-5' />
            <Link to={paths.Screens.AUTH_REGISTER} className='ml-2 hover:text-gray-300 font-sans'>
              Đăng ký
            </Link>
          </div>
        </div>
