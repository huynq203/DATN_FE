      ...
      <div className='container'>
        <div className='min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
          <div className='sm:mx-auto sm:w-full sm:max-w-md'>
            <h2 className='mt-6 text-center text-3xl font-sans text-gray-900'>Cập nhật mật khẩu</h2>
          </div>
              ...
              <form className='space-y-6' onSubmit={onSubmit}>
                <div>
                  ...
                  <div className='mt-1'>
                    ...
                    />
                    <label htmlFor='confirm_password' className='block text-sm font-sans text-gray-700'>
                      Xác nhận mật khẩu
                    </label>
                    <Input
                      type='password'
